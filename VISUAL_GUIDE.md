...
![The extension listed on chrome://extensions](screenshots/01-chrome-extensions-page.png)
...
| Light | Dark |
|---|---|
| ![Popup light](screenshots/09-popup-fa-light.png) | ![Popup dark](screenshots/10-popup-fa-dark.png) |
...
![The floating on-page icon](screenshots/11-floating-icon-demo.png)
...
*Persian / light theme:*
![Mass Block tab, Persian, light](screenshots/02-dashboard-block-fa-light.png)

*English / light theme:*
![Mass Block tab, English, light](screenshots/03-dashboard-block-en-light.png)

*English / dark theme:*
![Mass Block tab, English, dark](screenshots/04-dashboard-block-en-dark.png)

**Bulk Unblock** — same idea, in reverse:
![Bulk Unblock tab](screenshots/05-dashboard-unblock-en-dark.png)

**ID Finder** — turn a username into its numeric X ID:
![ID Finder tab](screenshots/06-dashboard-idfinder-en-dark.png)

**Blocked Accounts** — fetch, search, sort, bulk-unblock, and export your full blocked list as CSV:
![Blocked Accounts tab](screenshots/07-dashboard-blockedlist-en-dark.png)

**Settings** — theme, resume-after-refresh behavior, safety warnings, whitelist:
![Settings tab](screenshots/08-dashboard-settings-en-dark.png)
...
![افزونه تو صفحه chrome://extensions](screenshots/01-chrome-extensions-page.png)
...
| روشن | تیره |
|---|---|
| ![پاپ‌آپ روشن](screenshots/09-popup-fa-light.png) | ![پاپ‌آپ تیره](screenshots/10-popup-fa-dark.png) |
...
![آیکون شناور داخل صفحه](screenshots/11-floating-icon-demo.png)
...
*فارسی / تم روشن:*
![تب بلاک دسته‌جمعی، فارسی، روشن](screenshots/02-dashboard-block-fa-light.png)

*انگلیسی / تم روشن:*
![تب بلاک دسته‌جمعی، انگلیسی، روشن](screenshots/03-dashboard-block-en-light.png)

*انگلیسی / تم تیره:*
![تب بلاک دسته‌جمعی، انگلیسی، تیره](screenshots/04-dashboard-block-en-dark.png)

**آنبلاک دسته‌جمعی** — همون منطق، برعکس:
![تب آنبلاک دسته‌جمعی](screenshots/05-dashboard-unblock-en-dark.png)

**دریافت آیدی از یوزرنیم** — یوزرنیم رو به آیدی عددی X ID تبدیل کن:
![تب دریافت آیدی](screenshots/06-dashboard-idfinder-en-dark.png)

**لیست بلاک‌شده‌ها** — دریافت، جستجو، مرتب‌سازی، آنبلاک گروهی، و خروجی CSV از کل لیست بلاک‌هات:
![تب لیست بلاک‌شده‌ها](screenshots/07-dashboard-blockedlist-en-dark.png)

**تنظیمات** — تم، رفتار ازسرگیری بعد از رفرش، هشدارهای ایمنی، لیست استثنا:
![تب تنظیمات](screenshots/08-dashboard-settings-en-dark.png)
